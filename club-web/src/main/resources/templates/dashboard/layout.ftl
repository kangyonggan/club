...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/libs/bootstrap-table/dist/bpptstrap-table-fixed-columns.css">
    ...
    <link rel="stylesheet" href="${ctx}/ace/dist/css/prettify.min.css"/>
...
<script src="${ctx}/libs/bootstrap-table/dist/bootstrap-table-fixed-columns.js"></script>
...
<script src="${ctx}/libs/kindeditor/kindeditor-min.js"></script>
<script src="${ctx}/libs/kindeditor/lang/zh_CN.js"></script>
<script src="${ctx}/app/js/component.js"></script>
<script src="${ctx}/app/js/app-dashboard.js"></script>
<@block name="script"/>
</body>
</html>
